...
class LoginPage (BasePage):
    ...
    def get_error_message(self):
        # Locator for error message element - "Login was unsuccessful. Please correct the errors and try again.The credentials provided are incorrect"
        error_message_locator = (By.CSS_SELECTOR, "div[class='validation-summary-errors'] span")
    ...
    def is_login_successful(self):
        ...
        # Using .is_element_visible() function of BasePage class to check if logout link is visible, which indicates that login was successful
