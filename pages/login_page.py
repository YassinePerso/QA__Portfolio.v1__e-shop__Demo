...
class LoginPage (BasePage):
    ...
    def get_error_message(self):
        error_message_locator = (By.XPATH, "div[class='validation-summary-errors'] span")      #Locator for error message element
    ...
    def is_login_successful(self):
        ...
        logout_link_locator = (By.XPATH, "//a[@class='ico-logout']")
