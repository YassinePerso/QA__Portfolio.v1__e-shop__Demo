...
class HomePage (BasePage):
    ...
    def is_no_results_message_visible(self):
        # CSS selector for the "No products were found that matched your criteria."
        no_results_message = (By.CSS_SELECTOR, ".result")
    ...
    def is_search_error_message_visible(self):
        # The error message is displayed in a div with class "warning", so we locate it using CSS selector
        search_error_message = (By.CSS_SELECTOR, ".warning")
